...
class GameDataManagerTests: XCTestCase {
    ...
    func test_whenArrayWithLessThanFourElementsIsPassToPrepareData_ItProduceCorrectResults() {
        let words = [Word(word: "1", translation: "One"), Word(word: "2", translation: "Two"), Word(word: "3", translation: "Three")]
        manager.prepareGameData(words: words)
    ...
    func test_whenArrayWithFourElementsIsPassToPrepareData_ItProduceCorrectResults() {
        let words = [Word(word: "1", translation: "One"), Word(word: "2", translation: "Two"), Word(word: "3", translation: "Three"), Word(word: "4", translation: "Four")]
        manager.prepareGameData(words: words)
    ...
    func test_whenArrayWithMoreThanFourElementsIsPassToPrepareData_ItProduceCorrectResults() {
         let words = [Word(word: "1", translation: "One"), Word(word: "2", translation: "Two"), Word(word: "3", translation: "Three"), Word(word: "4", translation: "Four"), Word(word: "5", translation: "Five")]
         manager.prepareGameData(words: words)
